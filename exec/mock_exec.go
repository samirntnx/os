...
func (m *MockExecInterface) Command(name, arg string) CmdInterface {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Command", name, arg)
	ret0, _ := ret[0].(CmdInterface)
	return ret0
}
...
func (m *MockExecInterface) CommandContext(ctx context.Context, name, arg string) CmdInterface {
	m.ctrl.T.Helper()
